...
This document is the **authoritative format** for IMPS API request/response bodies. All bodies in **SOCKET_GUIDE.md**, **IMPS_Req_API_Bodies.md**, the Postman collection, and the **project code** must follow these structures.
...
<upi:ReqHbt xmlns:upi="http://npci.org/upi/schema/">
    ...
    <HbtMsg type="ALIVE|EOD" value=""/>
</upi:ReqHbt>
```

---

## ReqHbt – Acknowledgement
...
## 8.2 RespHbt – Heartbeat Response
...
## 9.1 ReqListAccPvd – List Providers Request
...
## RespListAccPvd – List Providers Response
...
<ns2:RespListAccPvd xmlns:ns2="http://npci.org/upi/schema/">
    ...
    <AccPvdList>
        <AccPvd name="" iin="" bankCode="" ifsc="" active="" prods="" lastModifiedTs="" featureSupported=""/>
    </AccPvdList>
</ns2:RespListAccPvd>
```
...
## 10.1 ReqValAdd – Name Enquiry / Address Validation Request

```xml
<ns2:ReqValAdd xmlns:ns2="http://npci.org/upi/schema/"
               xmlns:ns3="http://npci.org/cm/schema/">
    <Head ver="2.0"
          ts=""
          orgId=""
    ...
    <Payer addr=""
           ...
           type="ENTITY"
           code="">
        <Info><Identity id="" type="" verifiedName=""/><Rating verifiedAddress="TRUE"/></Info>
        <Device><Tag name="MOBILE" value=""/><Tag name="LOCATION" value=""/><Tag name="TYPE" value=""/><Tag name="cardAccpTrId" value=""/><Tag name="cardAccIdCode" value=""/></Device>
        <Ac addrType="MOBILE|ACCOUNT">
            <Detail name="MMID" value=""/>
            <Detail name="MOBNUM" value=""/>
...
## RespValAdd – Name Enquiry Response
...
*Source: NPCI IMPS specification. Use these formats only for API bodies in this project. SOCKET_GUIDE.md and project code must follow these structures.*
