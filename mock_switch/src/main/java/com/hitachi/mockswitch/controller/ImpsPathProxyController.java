...
/**
 * Same path format as IMPS: /imps/reqpay/{txnId}, /imps/reqchktxn/{txnId}, etc.
 * Use this when calling via mock_switch so the URL matches IMPS format, e.g.
 * https://host:8444/imps/reqpay/{{txnId}} (Switch - IMPS flow, account_master updated).
 */
@RestController
@RequestMapping("/imps")
public class ImpsPathProxyController {
