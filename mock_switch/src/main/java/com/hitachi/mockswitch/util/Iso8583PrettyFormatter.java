 ...
 * DE3  : 400000 (Processing Code – IMPS Pay)
 * DE4  : 000000100000 (Amount ₹1000.00)
 * ...
 */
public final class Iso8583PrettyFormatter {
    ...
    private static String formatAmountPaise(String paise12) {
        ...
        try {
            ...
            BigDecimal rupees = paise.divide(BigDecimal.valueOf(100), 2, java.math.RoundingMode.HALF_UP);
